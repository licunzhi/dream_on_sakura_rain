...
public enum  RestHttpStatus {
    ...
    RestHttpStatus(int value, String reasonPhrase) {
        this.value = value;
    ...
    public boolean is1xxInformational() {
        return HttpStatus.Series.INFORMATIONAL.equals(series());
    }
    ...
    public boolean is3xxRedirection() {
        return HttpStatus.Series.REDIRECTION.equals(series());
    }
    ...
    public RestHttpStatus.Series series() {
        return RestHttpStatus.Series.valueOf(this);
    }
     ...
     */
    public static RestHttpStatus valueOf(int statusCode) {
        RestHttpStatus status = resolve(statusCode);
        if (status == null) {
    ...
    @Nullable
    public static RestHttpStatus resolve(int statusCode) {
        for (RestHttpStatus status : values()) {
    ...
    public enum Series {
        ...
        public static RestHttpStatus.Series valueOf(int status) {
            int seriesCode = status / 100;
            for (RestHttpStatus.Series series : values()) {
        ...
        public static RestHttpStatus.Series valueOf(RestHttpStatus status) {
